...
import { chatApi, restaurantApi, pickSessionApi } from '@/lib/api';
...
export function ChatWidget() {
  ...
  // Companion tab removed — contacts are in separate ContactsPanel
    ...
    >
      <div style={{ position: 'relative', width: 720, maxWidth: 'calc(100vw - 16px)', animation: 'chatIn 0.2s ease-out' }}>
        ...
        <div style={{ width: 260, minWidth: 260, background: 'var(--bg2)', borderRight: '1px solid var(--card-border)', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}
          ...
          {/* Header */}
          <div style={{ padding: '11px 14px', borderBottom: '1px solid var(--card-border)', background: 'linear-gradient(135deg, rgba(255,92,40,0.06), rgba(57,255,209,0.03))' }}>
            <span style={{ fontSize: 13, fontWeight: 700, color: 'var(--text)' }}>{t('dialogs')}</span>
          </div>
