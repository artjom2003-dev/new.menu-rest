...
// Координаты станций метро (lat, lng). Используются как "якорь" для сортировки результатов
// по расстоянию когда юзер упомянул станцию: "хочу пиво на шаболовской" → если на Шаболовской
// ничего нет, ищем рестораны в Москве, ближайшие к этим координатам.
// Список — ключевые станции МСК и СПБ. Расширять по мере необходимости.
const METRO_COORDS: Record<string, [number, number]> = {
  // ─── Москва (lat, lng) ───
  'шаболовская': [55.7196, 37.6079], 'тульская': [55.7088, 37.6224],
  'октябрьская': [55.7298, 37.6121], 'ленинский проспект': [55.7065, 37.5860],
  'добрынинская': [55.7280, 37.6228], 'серпуховская': [55.7281, 37.6225],
  'полянка': [55.7407, 37.6189], 'третьяковская': [55.7407, 37.6259],
  'новокузнецкая': [55.7423, 37.6300], 'павелецкая': [55.7305, 37.6361],
  'таганская': [55.7423, 37.6534], 'марксистская': [55.7430, 37.6604],
  'площадь революции': [55.7568, 37.6212], 'театральная': [55.7572, 37.6191],
  'охотный ряд': [55.7574, 37.6155], 'тверская': [55.7651, 37.6058],
  'пушкинская': [55.7651, 37.6063], 'чеховская': [55.7651, 37.6058],
  'арбатская': [55.7522, 37.6017], 'смоленская': [55.7470, 37.5828],
  'киевская': [55.7438, 37.5658], 'парк культуры': [55.7361, 37.5928],
  'кропоткинская': [55.7458, 37.6047], 'боровицкая': [55.7510, 37.6111],
  'библиотека имени ленина': [55.7521, 37.6098],
  'тургеневская': [55.7657, 37.6395], 'чистые пруды': [55.7657, 37.6383],
  'сретенский бульвар': [55.7657, 37.6395], 'кузнецкий мост': [55.7616, 37.6256],
  'лубянка': [55.7595, 37.6258], 'китай-город': [55.7556, 37.6321],
  'красные ворота': [55.7693, 37.6493], 'комсомольская': [55.7752, 37.6543],
  'красносельская': [55.7800, 37.6678], 'сокольники': [55.7886, 37.6800],
  'белорусская': [55.7766, 37.5829], 'маяковская': [55.7705, 37.5957],
  'новослободская': [55.7720, 37.6014], 'менделеевская': [55.7720, 37.6014],
  'трубная': [55.7677, 37.6225], 'цветной бульвар': [55.7677, 37.6207],
  'марьина роща': [55.7926, 37.6183], 'достоевская': [55.7779, 37.6132],
  'савёловская': [55.7943, 37.5891], 'савеловская': [55.7943, 37.5891],
  'дмитровская': [55.8073, 37.5828], 'тимирязевская': [55.8194, 37.5752],
  'академическая': [55.6877, 37.5742], 'профсоюзная': [55.6781, 37.5634],
  'университет': [55.6927, 37.5347], 'воробьёвы горы': [55.7100, 37.5594],
  'воробьевы горы': [55.7100, 37.5594],
  'спортивная': [55.7233, 37.5650], 'фрунзенская': [55.7269, 37.5817],
  'бауманская': [55.7724, 37.6790], 'курская': [55.7587, 37.6592],
  'чкаловская': [55.7574, 37.6592], 'римская': [55.7503, 37.6810],
  'площадь ильича': [55.7474, 37.6849], 'авиамоторная': [55.7517, 37.7172],
  'аэропорт': [55.8004, 37.5325], 'сокол': [55.8050, 37.5151],
  'динамо': [55.7901, 37.5582], 'войковская': [55.8189, 37.4978],
  'речной вокзал': [55.8540, 37.4760], 'водный стадион': [55.8398, 37.4870],
  'автозаводская': [55.7068, 37.6577], 'коломенская': [55.6783, 37.6645],
  'каширская': [55.6552, 37.6492], 'кантемировская': [55.6358, 37.6589],
  'царицыно': [55.6173, 37.6680], 'орехово': [55.6135, 37.7036],
  'домодедовская': [55.6101, 37.7188],
  'вднх': [55.8217, 37.6394], 'алексеевская': [55.8082, 37.6386],
  'рижская': [55.7919, 37.6360], 'сухаревская': [55.7747, 37.6332],
  'тургеневская площадь': [55.7657, 37.6395],
  // ─── СПБ (lat, lng) ───
  'невский проспект': [59.9356, 30.3257], 'гостиный двор': [59.9335, 30.3349],
  'площадь восстания': [59.9305, 30.3617], 'маяковская спб': [59.9311, 30.3554],
  'владимирская': [59.9275, 30.3478], 'достоевская спб': [59.9275, 30.3478],
  'площадь ленина': [59.9559, 30.3556], 'чернышевская': [59.9436, 30.3624],
  'технологический институт': [59.9176, 30.3185], 'балтийская': [59.9080, 30.2992],
  'нарвская': [59.9015, 30.2754], 'кировский завод': [59.8794, 30.2622],
  'автово': [59.8674, 30.2618], 'проспект ветеранов': [59.8421, 30.2516],
  'московская': [59.8508, 30.3215], 'парк победы спб': [59.8665, 30.3217],
  'звёздная': [59.8331, 30.3490], 'звездная': [59.8331, 30.3490],
  'купчино': [59.8307, 30.3760], 'московские ворота': [59.8918, 30.3175],
  'фрунзенская спб': [59.9078, 30.3186],
  'петроградская': [59.9665, 30.3110], 'горьковская': [59.9560, 30.3186],
  'чёрная речка': [59.9852, 30.3010], 'черная речка': [59.9852, 30.3010],
  'удельная': [60.0162, 30.3168], 'озерки': [60.0335, 30.3221],
  'проспект просвещения': [60.0518, 30.3324], 'парнас': [60.0673, 30.3338],
  'василеостровская': [59.9430, 30.2779], 'приморская': [59.9485, 30.2347],
  'площадь александра невского': [59.9237, 30.3849], 'елизаровская': [59.8955, 30.4252],
  'ломоносовская': [59.8755, 30.4423], 'обухово': [59.8517, 30.4564],
  'рыбацкое': [59.8294, 30.4961],
  'комендантский проспект': [60.0083, 30.2589], 'старая деревня': [59.9893, 30.2542],
  'крестовский остров': [59.9728, 30.2573],
  'адмиралтейская': [59.9357, 30.3149], 'садовая': [59.9272, 30.3162],
  'спасская': [59.9275, 30.3201], 'сенная площадь': [59.9275, 30.3204],
  'звенигородская': [59.9215, 30.3331], 'пушкинская спб': [59.9202, 30.3434],
  'обводный канал': [59.9143, 30.3470], 'волковская': [59.8964, 30.3577],
  'бухарестская': [59.8839, 30.3681], 'международная спб': [59.8773, 30.3811],
  'проспект славы': [59.8595, 30.3772], 'дунайская': [59.8482, 30.3800],
  'шушары': [59.8326, 30.3904],
  'ладожская': [59.9326, 30.4391], 'новочеркасская': [59.9296, 30.4112],
  'проспект большевиков': [59.9203, 30.4669], 'улица дыбенко': [59.9075, 30.4831],
};

/** Найти координаты станции метро по имени (с учётом склонений). */
export function getMetroCoords(name: string | undefined | null): [number, number] | undefined {
  if (!name) return undefined;
  const n = name.toLowerCase().trim();
  if (METRO_COORDS[n]) return METRO_COORDS[n];
  // Проверяем стеммированные варианты ("шаболовской" → "шаболовская")
  const stem = n.replace(/(?:ой|ая|ую|ом|ем|ах|ях|ке|не|те|де)$/, '');
  for (const [key, coords] of Object.entries(METRO_COORDS)) {
    if (key === n || key.startsWith(stem) || n.startsWith(key.slice(0, Math.max(key.length - 2, 5)))) {
      return coords;
    }
  }
  return undefined;
